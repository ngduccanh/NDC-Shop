...
window.onload = function () {
    ...
    for (var t of tags) addTags(t, "trangchu.html?search=" + t, true);
...
function phanTich_URL_chiTietSanPham() {
    ...
    // Đổi title
    document.title = nameProduct + ' - SmartPoint';
    ...
    addSmallImg("img/chitietsanpham/iPhone-16-Pro-va-Pro-Max-1024x576.jpg");
    addSmallImg("img/chitietsanpham/iPhone-16-Pro-va-Pro-Max-co-4-mau-sac.jpg");
    addSmallImg("img/chitietsanpham/Hieu-nang-vuot-troi-cua-chip-A18-Pro-tien-trinh-3nm.jpg");
    addSmallImg("img/chitietsanpham/Camera-chinh-iPhone-16-Pro.jpg");
    addSmallImg("img/chitietsanpham/Camera-goc-rong-iPhone-16-Pro.jpg");
    addSmallImg("img/chitietsanpham/Camera-tele-iPhone-16-Pro.jpg");
...
function getDetailPromo(sp) {
    switch (sp.promo.name) {
        ...
        case 'giareonline':
            ...
            return `Sản phẩm sẽ được giảm ` + span + `₫ khi mua hàng online bằng thẻ MB Bank.`;
